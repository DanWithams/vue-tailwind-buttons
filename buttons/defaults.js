...
const variants = {
    ...
    secondary: {
        ...
        outline: {
            classes: [ 'bg-transparent', 'text-cyan-400', 'dark:text-cyan-500', 'hover:text-cyan-500', 'dark:hover:text-cyan-700', 'focus:text-cyan-500', 'dark:focus:text-cyan-700' ],
            insetClasses: [ 'border-2', 'border-cyan-400', 'dark:border-cyan-500', 'group-hover:border-cyan-500', 'dark:group-hover:border-cyan-700', 'group-focus:border-cyan-500', 'dark:group-focus:border-cyan-700' ],
        },
    },
    positive: {
        solid: {
        ...
        outline: {
            classes: [ 'bg-transparent', 'text-green-400', 'dark:text-green-500', 'hover:text-green-500', 'dark:hover:text-green-700', 'focus:text-green-500', 'focus:text-green-700' ],
            insetClasses: [ 'border-2', 'border-green-400', 'dark:border-green-500', 'group-hover:border-green-500', 'dark:group-hover:border-green-700', 'group-focus:border-green-500', 'dark:group-focus:border-green-700' ],
        },
    },
    negative: {
        solid: {
        ...
        outline: {
            classes: [ 'bg-transparent', 'text-red-400', 'dark:text-red-500', 'hover:text-red-500', 'dark:hover:text-red-700', 'focus:text-red-500', 'dark:focus:text-red-700' ],
            insetClasses: [ 'border-2', 'border-red-400', 'dark:border-red-500', 'group-hover:border-red-500', 'dark:group-hover:border-red-700', 'group-focus:border-red-500', 'dark:group-focus:border-red-700' ],
        },
    },
    default: {
        solid: {
        ...
        outline: {
            classes: [ 'bg-transparent', 'text-zinc-400', 'dark:text-zinc-500', 'hover:text-zinc-500', 'dark:hover:text-zinc-700', 'focus:text-zinc-500', 'dark:focus:text-zinc-700' ],
            insetClasses: [ 'border-2', 'border-zinc-400', 'dark:border-zinc-500', 'group-hover:border-zinc-500', 'dark:group-hover:border-zinc-700', 'group-focus:border-zinc-500', 'dark:group-focus:border-zinc-700' ],
        },
    },
    transparent: {
        solid: {
    ...
    Object.keys(variants)
        .forEach(key => {
            ...
            defaults[key] = {
                baseClasses: rounded,
                solid: {
                    classes: mergeTwClasses(_.get(classes, key + '.solid.classes', variants[key].solid.classes), rounded),
                    insetClasses: mergeTwClasses(baseDefaults.classes, _.get(classes, key + '.solid.insetClasses', variants[key].solid.insetClasses), rounded),
                },
                outline: {
                    classes: mergeTwClasses(_.get(classes, key + '.outline.classes', variants[key].outline.classes), rounded),
                    insetClasses: mergeTwClasses(_.get(baseDefaults.classes, classes, key + '.outline.insetClasses', variants[key].outline.insetClasses), rounded),
                }
            }
        });
